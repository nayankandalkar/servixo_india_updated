...
function Slider4() {
    ...
    fetch(url, requestData)
      ...
      .then(data => {
        ...
        console.log(data.data.SliderImages[0].images);
        data.data.SliderImages.map((data,index)=>(
            
            urls.push("https://servixoindia.com/servixoindia/uploads/slider-images/"+data.images)

          //  console.log("https://servixoindia.com/servixoindia/uploads/slider-images/"+data.images)
               //setSlideImages()
             //  const urls = [];
              // .push()
            ))
